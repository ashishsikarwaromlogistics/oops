...
class Constants {
    companion object{
        ...
        val IS_INCRYPT = "IS_INCRYPT"
        val IN_DATE = "IN_DATE"
        val OUT_DATE = "OUT_DATE"
        val PUNCH_TIME = "PUNCH_TIME"
        val PRINTER = "PRINTER"
        val SENDDATA = "SENDDATA"
        public const val JWTTOKEN = "JWTTOKEN"
        val BCODE = "BCODE"
        val BAJAJ = "BAJAJ"
        val bajajlist_with_realtion = "bajajlist_with_realtion"
        val BNAME = "BNAME"
        val EMPNAME = "EMPNAME"
