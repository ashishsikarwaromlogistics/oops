...
class GatePassInAdap(val response: ArrayList<Response>, val myinterface: GatePassInterface?) : RecyclerView.Adapter<GatePassInAdap.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.tv_ch.setText(resp.CHALLAN_NO)
        holder.tv_cn.setText(resp.CN_NO)
        holder.tv_pkg.setText(resp.CN_PKG)
        holder.tv_act_wt.setText(resp.CN_PKG)
